...
@CustomType
public final class GetAccountsClusterConfigurationTopologySpreadConstraint {
    private @Nullable Double maxSkew;
    private @Nullable String topologyKey;
    private @Nullable String whenUnsatisfiable;

    private GetAccountsClusterConfigurationTopologySpreadConstraint() {}
    ...
    public static Builder builder(GetAccountsClusterConfigurationTopologySpreadConstraint defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String whenUnsatisfiable;
        public Builder() {}
        public Builder(GetAccountsClusterConfigurationTopologySpreadConstraint defaults) {
        ...
        public GetAccountsClusterConfigurationTopologySpreadConstraint build() {
            final var _resultValue = new GetAccountsClusterConfigurationTopologySpreadConstraint();
