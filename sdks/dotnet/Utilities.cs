...
namespace Pulumi.QdrantCloud
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.QdrantCloud.version.txt");
    ...
    internal sealed class QdrantCloudResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public QdrantCloudResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
